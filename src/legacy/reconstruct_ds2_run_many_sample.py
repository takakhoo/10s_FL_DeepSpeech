...
#rsync -avz lisplab0:/scratch/f006pq6/datasets/librispeech_sampled_600_file_0s_4s . define function to pretty print all the configuration in argparse, column tab
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cpt_resume", type=str, default=None, help="Path to checkpoint to resume from")
    parser.add_argument("--init_method", type=str, default='uniform', help="Initialization method for input reconstruction")
    ...
    exp_name = f"DS2_batchstart_{FLAGS.batch_start}_batch_end_{FLAGS.batch_end}_opt_{FLAGS.optimizer_name}_lr_{FLAGS.lr}_reg_{FLAGS.reg}_regw_{FLAGS.reg_weight}_top-grad-perc_{FLAGS.top_grad_percentage}"
